...
| 文档 | 内容 |
|------|------|
| [docs/本系统套利流程.md](docs/本系统套利流程.md) | 本仓库：启动、三条环、格子、容量校验、执行、滤网 |
...
| [web/public/参考项目.html](web/public/参考项目.html) | 参考终端监控布局原型（Rich Live 三种模式） |
...
| [docs/平仓判据备选方案B.md](docs/平仓判据备选方案B.md) | **已废弃**。曾用往返净利闸门；现回退方案 A（D1-c） |
